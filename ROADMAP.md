...
**Last Updated**: 2026-03-17 | **Current Version**: v0.12.11 | **Target**: v1.0.0 stable
...
| Metric | Current (v0.12.11) | Target (v1.0.0) |
|--------|-------------------|-----------------|
...
v0.12.10 ✅ → Case-insensitive literals, DigitPrefilter O(n²) fix (#137)
         ↓
v0.12.11 (Current) ✅ → ReverseSuffix multi-wildcard, COREGEX_DEBUG logging
         ↓
